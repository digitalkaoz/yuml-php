...
class ClassesRequestTest extends \PHPUnit_Framework_TestCase
{
    public function testGetProperties()
    {
        ...
        $properties = $request->buildProperties($this->loadClass('YumlPhp\Tests\Fixtures\Bar'));
    ...
    public function testGetMethods()
    {
        ...
        $methods = $request->buildMethods($this->loadClass('YumlPhp\Tests\Fixtures\Bar'));
    ...
    public function testGetInterfaces()
    {
        ...
        $methods = $request->buildInterfaces($this->loadClass('YumlPhp\Tests\Fixtures\BarWithInterface'));
        $this->assertInternalType('array', $methods);
    ...
    public function testBuildName()
    {
        ...
        $name = $request->buildName($this->loadClass('YumlPhp\Tests\Fixtures\Bar'));
        $this->assertEquals('YumlPhp/Tests/Fixtures/Bar', $name);

        $name = $request->buildName($this->loadClass('YumlPhp\Tests\Fixtures\BarInterface'));
        $this->assertEquals('<<YumlPhp/Tests/Fixtures/BarInterface>>', $name);

        $name = $request->buildName($this->loadClass('YumlPhp\Tests\Fixtures\BarInterface'), '__', '__');
    ...
    public function testBuildParent()
    {
        ...
        $name = $request->buildParent($this->loadClass('YumlPhp\Tests\Fixtures\Foo'));
        $this->assertEquals('YumlPhp/Tests/Fixtures/Bazz', $name);

        $name = $request->buildParent($this->loadClass('YumlPhp\Tests\Fixtures\FooInterface'));
